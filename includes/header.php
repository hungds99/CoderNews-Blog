<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
  <div class="container">
    ...
    <a href="index.php" class="navbar-brand  logo"><span>CODER<span class="text-primary">NEWS</span></span><i class="mdi mdi-layers"></i></a>
        ...
        ?>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              ?>
                <a class="dropdown-item" href="category.php?catid=<?= $sub['SubCategoryId'] ?>"><?= $sub["Subcategory"] ?></a>
              <?php
              }
              ?>
