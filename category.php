...
<head>
    ...
    <title>Coder News | Danh mục bài viết</title>
        ...
        <div class="row" style="margin-top: 4%">
            ...
            <div class="col-md-8">
                ...
                <?php
            		if($cate === 0) {
            	?>
                		<h6>Danh mục: <?=$row['category']?>, <?=$row['subcategory']?> </h6>
                <?php
            			$cate = 1;
            		}
          		?>
                    ...
                    <div class="col-9">
                        <div class="card-body">
                            ...
                            <p style="font-size: 12px;">
								<em>Danh mục : </em> <a href="category.php?catid=<?=$row['cid']?>"><?=$row['category']?></a> || 
								<em>Ngày đăng :</em> <?=$row['postingdate']?> 
							</p>
                ...
                <ul class="pagination justify-content-center mb-4">
                    ...
                    <li class="page-item"><a href="?pageno=<?php echo $total_pages; ?>" class="page-link">Trang cuối</a>
                    </li>
                </ul>
                <?php } ?>
                <!-- Pagination -->
